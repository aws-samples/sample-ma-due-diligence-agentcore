...
Amazon Bedrock Knowledge Bases. This specialist is the primary reader of
...
- ``kb_retrieve`` (enrichment): Fetches grounding passages from the
  Amazon Bedrock Knowledge Bases to add qualitative context to the top
  screening hits.
...
def kb_retrieve(query: str, top_k: int = 5) -> list[dict[str, Any]]:
    """Fetch grounding passages from Amazon Bedrock Knowledge Bases.
